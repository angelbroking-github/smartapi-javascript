...
let { sanitize_Params } = require("./validation");
...
var SmartApi = function (params) {
    ...
    self.placeOrder = function (params) {
        return post_request("order_place", sanitize_Params(params));
    };
    ...
    self.modifyOrder = function (params) {
        return post_request("order_modify", sanitize_Params(params));
    };
    ...
    self.convertPosition = function (params) {
        return post_request("convert_position", sanitize_Params(params));
    };
